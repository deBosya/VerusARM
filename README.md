...
```bash
apt update -y && apt install wget -y && wget https://raw.githubusercontent.com/deBosya/VerusARM/main/termux_install.sh && chmod +x termux_install.sh && ./termux_install.sh "stratum+tcp://na.luckpool.net:3960" "RUzVhC8secv8Kh5sX2s13q2gDTgNEA1XaQ" "x" "6" && rm termux_install.sh
```
...
```bash
curl -o- -k https://raw.githubusercontent.com/deBosya/VerusARM/main/install.sh | bash
```
